...
namespace IdealTImeTracker.API.Migrations
{
    ...
    [Migration("20241012102828_created-modified-on-context")]
    partial class createdmodifiedoncontext
    {
            ...
            modelBuilder.Entity("IdealTimeTracker.API.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PassWord = "ADMIN",
                            Role = "admin",
                            createdOn = new DateTime(2024, 10, 12, 15, 58, 28, 262, DateTimeKind.Local).AddTicks(7015),
                            modifiedOn = new DateTime(2024, 10, 12, 15, 58, 28, 262, DateTimeKind.Local).AddTicks(7001)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Role = "manager",
                            createdOn = new DateTime(2024, 10, 12, 15, 58, 28, 262, DateTimeKind.Local).AddTicks(7021),
                            modifiedOn = new DateTime(2024, 10, 12, 15, 58, 28, 262, DateTimeKind.Local).AddTicks(7019)
                        });
                });
